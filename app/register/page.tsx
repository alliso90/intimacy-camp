...
const getSteps = (isLeader: boolean): Step[] => {
  const baseSteps: Step[] = [
    ...
    { id: 5, title: "Leadership Status", fields: ["isLeader"] },
  ];

  if (isLeader) {
    baseSteps.push({ id: 6, title: "Ministry Information", fields: ["ministry", "customMinistry"] });
  }
...
;
  ...
  return formData[field].trim() !== "";
   ...
   // app/register/page.tsx (updated handleSubmit function)
            ...
            <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-pink-200 via-purple-200 to-blue-200 p-4">
                ...
                >
                    ...
                    <p className="text-gray-600 mb-8">
                        Thank you for registering for The Intimacy Camp 2026. You'll receive a confirmation email shortly.
                    </p>
                ...
                <div className="mb-6">
                    <div className="flex justify-between mb-2">
                        {STEPS.map((step) => (
                            <div
                                key={step.id}
                                className={`w-full h-2 mx-1 rounded-full transition-colors ${
                                    step.id <= currentStep
                    ...
                    <div className="flex gap-4 mt-8">
                        ...
                        {currentStep < STEPS.length ? (
                            <button
                                onClick={handleNext}
                                disabled={!canProceed()}
                                className={`flex-1 h-12 px-6 rounded-lg font-medium flex items-center justify-center gap-2 transition-all ${
                                    canProceed()
